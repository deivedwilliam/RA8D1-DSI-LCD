...
const mipi_dsi_cfg_t g_mipi_dsi0_cfg =
        { .p_mipi_phy_instance = &g_mipi_phy0,
          ...
          .vertical_back_porch = (13 - 4),
          .vertical_front_porch = (500 - 480 - 13 - 4),
          .vertical_sync_polarity = (DISPLAY_SIGNAL_POLARITY_HIACTIVE != DISPLAY_SIGNAL_POLARITY_HIACTIVE),

          .horizontal_active_lines = 640,
          .horizontal_sync_lines = 64,
          .horizontal_back_porch = (80 - 64),
          .horizontal_front_porch = (800 - 640 - 80 - 64),
          .horizontal_sync_polarity = (DISPLAY_SIGNAL_POLARITY_LOACTIVE != DISPLAY_SIGNAL_POLARITY_HIACTIVE),

          .video_mode_delay = 640 /* This value was calculated by FSP. An override is available but not recommended for most users */,
...
const display_cfg_t g_display0_cfg =
        ...
        .input[0] =
        {
          ...
          .output =
                  { .htiming =
                  { .total_cyc = 800, .display_cyc = 640, .back_porch = 80, .sync_width = 64, .sync_polarity =
                            DISPLAY_SIGNAL_POLARITY_LOACTIVE },
                    .vtiming =
                    { .total_cyc = 500, .display_cyc = 480, .back_porch = 13, .sync_width = 4, .sync_polarity =
